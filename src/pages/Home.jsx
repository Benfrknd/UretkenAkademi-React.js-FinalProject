...
export default function BodyTest() {
  ...
  return (
    <>
        <div className='grid p-10 gap-y-6 rounded-full mx-auto w-full mt-8 bg-gradient-to-r from-metal to-metal container text-slate-200'>
        ...
        <div className='flex justify-center items-center p-10 gap-y-6 rounded-full mx-auto w-full mt-8 bg-gradient-to-r from-bermuda to-metal container text-slate-200'>
          Duyurular
        </div>
        ...
        <div class="mx-auto grid grid-row-2 grid-cols-2 grid-flow-row gap-4 mt-16 mb-10">
          ...
          <div class="mx-auto w-96 h-24 bg-gradient-to-r from-metal to-midnight rounded-lg flex flex-col justify-center items-center gap-y-3">
